...
target AS (
    SELECT
        ...
        CASE
            WHEN b.category IN ('解剖生理', '生化学', '薬理', '病理', '遺伝', '循環器', '呼吸器', '消化器', '腎臓', '内分泌代謝', '神経', '血液', '免疫', '感染症', '中毒・環境異常症', '救急', '小児', '産科', '婦人科', '泌尿器', '眼科', '耳鼻咽喉科', '皮膚', '精神', '整形', '麻酔', '放射線', '公衆衛生', '４連問') THEN b.category
            WHEN b.category IN ('個体の反応', '産婦人科系', '腎・尿路系', '救急・中毒') THEN coalesce(bs.cat, fb.cat)
